		 ...
		 :style="{
			...
			<swiper-item class="u-swiper-item" v-for="(item, index) in list" :key="index">
				<view class="u-list-image-wrap" @tap.stop.prevent="listClick(index)" :class="[uCurrent != index ? 'u-list-scale' : '']" :style="{
					...
					<image class="u-swiper-image" :src="item[name]+'?x-oss-process=image/resize,w_900/format,webp/quality,Q_100' || item+'?x-oss-process=image/resize,w_900/format,webp/quality,Q_100'" :mode="imgMode"></image>
